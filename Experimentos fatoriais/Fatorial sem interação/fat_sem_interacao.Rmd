---
title: "Identificando Interações em Experimentos Fatoriais"
...
- Criar gráficos de interação para representar os efeitos de dois fatores em um experimento fatorial.
- Analisar dados experimentais para verificar se há interação entre os fatores.
- Representar croquis experimentais usando o pacote AgroR.
...
Agrupamos os dados por combinações de peneiras e densidades, calculando a altura média para cada combinação.
...
O gráfico de interação é utilizado para verificar visualmente a presença de interação entre os fatores.
...
O croqui experimental apresenta visualmente o delineamento do experimento.
...
Utilizamos a função *fat2.dbc* para ajustar o modelo estatístico, considerando os fatores qualitativos.

```{r}
# carregando o pacote ExpDes.pt
library(ExpDes.pt)
...
Utilizamos a função *FAT2DBC* para ajustar o modelo estatístico, considerando os fatores qualitativos.
