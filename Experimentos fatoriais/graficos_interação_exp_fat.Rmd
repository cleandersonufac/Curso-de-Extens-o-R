...
- Experimentos fatoriais permitem analisar os efeitos de dois ou mais fatores simultaneamente.
- Gráficos de interação são ferramentas visuais úteis para identificar interações.
- O pacote AgroR facilita a criação de croquis experimentais para visualização do delineamento.
